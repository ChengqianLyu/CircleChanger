...
class CircleChanger(object):
    ...
    def __init__(self, x, y, radius, fill_color, colors):
        ...
        self.colors = colors
        self.circle.originalcolor = fill_color
        self.index = 0
    ...
    def swallow(self, other_circle_changer):
        ...
        #   NO CREDIT if you use the distance formula here.
        ################################################################
        nx = (self.circle.center.x + other_circle_changer.circle.center.x)/2
        ny = (self.circle.center.y + other_circle_changer.circle.center.y)/2
        nr = self.get_distance_from(other_circle_changer.circle.center)/2
        colors = self.colors + other_circle_changer.colors
        newcolor = 'red'
        nc = CircleChanger(nx,ny,nr,newcolor,colors)
        return nc
    ...
    def change_to_original_color(self):
        ...
        #   (below).  Third, implement and test this method.
        ################################################################
        self.circle.fill_color = self.circle.originalcolor
